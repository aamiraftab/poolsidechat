jQuery(function ($) {
    ...
    com.poolside.chat.findUniqueSearchUsers = function (searchResults) {
    ...
    com.poolside.chat.addUserIfNeeded = function (username) {
    ...
    com.poolside.chat.getAvatarColor = function (username) {
        var color = '55C1E7';
        var idx = uniqueUsers.findIndex(function (n) { return n == username; });
